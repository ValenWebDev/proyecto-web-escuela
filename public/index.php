...
<section class="hero | u-flex-center u-text-center">
    <img class="hero__logo" src="/src/assets/img/logo.png" alt="Logo EEST Nº1">
...
<section class="specialties | u-container">
    ...
    <div class="specialties__carousel js-carousel">
        <img class="specialties__slide is-active" src="/src/assets/img/CICLO-BASICO.png"  alt="Ciclo básico">
        <img class="specialties__slide" src="/src/assets/img/TECNICA-EN-INF.png" alt="Técnica en Informática">
        <img class="specialties__slide" src="/src//assets/img/PROGRAMACION3.png"  alt="Programación">
        <img class="specialties__slide" src="/src//assets/img/MAESTRO-2.png" alt="M.M.O.">
    </div>
