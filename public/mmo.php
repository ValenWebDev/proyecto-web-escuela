<?php
    $pageTitle = 'Maestro Mayor de Obra';
    $pageSlug  = 'page--mmo';
...
<main class="historia | u-container">
    ...
    <section class="historia__intro">
        ...
        <p class="historia__paragraph">
            <strong>Objetivos:</strong> El título Maestro Mayor de Obras habilita para la ejecución del proyecto, dirección y/o construcción de edificios de hasta planta baja, un subsuelo, cuatro pisos altos y dependencia en la azotea.
        </p>

        <p class="historia__paragraph">
            Las tareas profesionales que realizará el Maestro Mayor de Obra son:
        </p>
        ...
        <p class="historia__paragraph">
            El Maestro Mayor de Obra puede construir:
        </p>
